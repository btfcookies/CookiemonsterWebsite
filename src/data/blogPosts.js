...
const blogPosts = [
  {
    ...
    date: "August 24, 2026",
    text: "I noticed something interesting in QBReader's readTossup() function. I believe that most people assume QBReader displays text word by word in a uniform amount of time. However the function it uses to calculate the delay between words does not use a simple delay. The formula that it uses is //time = log(word.length) + 1//. This means that the longer the word, the more delay there is which is a reasonable feature to have. But you may be wondering, why does it add 1? This is to maintain non zero delays for one letter words such as 'a', since log(1) is 0. "
  },
  {
    title: "Vibe Coding",
    date: "August 16, 2026",
  ...
  }, 
  {
    ...
    images: [
      { src: "/Figure_2.png", caption: "This is the plot that I made for TIC 261136679", alt: "temp" },
    ],
   },
  {
